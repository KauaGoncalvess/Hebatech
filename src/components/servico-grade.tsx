        ...
        <li key={s.slug}>
          ...
          >
            <span className="relative block aspect-[16/10] overflow-hidden text-white">
              ...
              />
              <span className="absolute top-2.5 left-2.5 rounded-full bg-black/60 px-2.5 py-1 font-mono text-[9px] tracking-[0.12em] text-accent uppercase backdrop-blur sm:top-3 sm:left-3 sm:px-3 sm:py-1.5 sm:text-[10px] sm:tracking-[0.14em]">
                {s.etiqueta}
              </span>
            </span>
            ...
            <span className="flex flex-1 flex-col p-4 sm:p-5">
              ...
              <span className="mt-3 hidden flex-1 text-[13.5px] leading-relaxed text-white/55 sm:block">
                {s.resumo}
              </span>
              ...
              <span className="mt-4 flex flex-1 items-end justify-between gap-2 sm:mt-5 sm:flex-none">
                ...
                <span
                  aria-hidden
                  className="hidden h-8 w-8 shrink-0 items-center justify-center rounded-full border border-line-strong font-mono text-[13px] transition-colors group-hover:border-accent group-hover:bg-accent group-hover:text-black sm:flex"
                >
                  →
                </span>
              </span>
