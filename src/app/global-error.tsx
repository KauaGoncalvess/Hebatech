    ...
    <html lang="pt-BR" className={classesDeFonte}>
      <body>
        <main className="mx-auto flex min-h-screen max-w-[640px] flex-col justify-center px-5">
          ...
          <p className="mt-6 text-corpo-g leading-relaxed text-texto-3">
          ...
          <button
            type="button"
            onClick={reset}
            className="mt-9 flex h-14 w-fit items-center rounded-full bg-accent px-8 font-mono text-nota font-bold tracking-[0.12em] text-black uppercase transition-colors hover:bg-accent-hover"
          >
            Recarregar
          </button>
        </main>
